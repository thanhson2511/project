            ...
            <?php 
              ...
              <tr>
                ...
                <td><?php echo $user['created_at'] ?></td>
                  <td>
                      <a href="index.php?mod=user&act=detail&id=<?=$user['id']?>" class="btn btn-primary"><i class="fas fa-info-circle"></i></a>
                      <a href="index.php?mod=user&act=edit&id=<?=$user['id']?>" class="btn btn-success"><i class="fas fa-user-edit"></i></a>
                      <a href="index.php?mod=user&act=destroy&id=<?=$user['id']?>" class="btn btn-danger"><i class="fas fa-user-slash"></i></a>
                   </td>
                </tr>
       <?php } ?>
   </table>
