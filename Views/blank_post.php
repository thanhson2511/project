            ...
            <?php 
              ...
              <tr>
                ...
                <td><?php echo $post['content'] ?></td>
                  <td>
                      <a href="index.php?mod=post&act=detail&id=<?=$post['id']?>" class="btn btn-primary"><i class="far fa-eye"></i></a>
                      <a href="index.php?mod=post&act=edit&id=<?=$post['id']?>" class="btn btn-success"><i class="far fa-edit"></i></a>
                      <a href="index.php?mod=post&act=destroy&id=<?=$post['id']?>" class="btn btn-danger"><i class="far fa-trash-alt"></i></a>
                   </td>
                </tr>
       <?php } ?>
   </table>
